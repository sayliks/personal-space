...
- [[链接如何工作]] — 为什么我更愿意连接笔记，而不是把它们收进文件夹
...
这些都还不完整，而这正是重点。我宁愿保留一篇会被我反复回访的粗糙笔记，也不想留下一个漂亮却再也不会打开的成品。`,
  },
  {
    ...
    summary: "为什么我连接笔记而不是归档它们，以及反向链接如何改变写作方式。",
    category: "整理",
    tags: ["入门", "连接"],
    publishedDaysAgo: 18,
    content: `当一篇笔记里的某个想法让我想起另一篇，我就直接在句子里把它们连起来。链接只是另一篇笔记的标题，用双中括号包住，比如 [[从这里开始]]。

我没想到自己会这么喜欢的一点是：它是双向的。打开一篇笔记，底部会显示所有指向它的地方。我不必记得自己在哪里提过某个想法，连接会自己把路径带回来。
...
这也回到 [[链接如何工作]]：一篇持续被修改的笔记，往往也会慢慢收集更多链接。打磨和连接，其实在朝同一个方向用力。
...
**连接** 会穿过路径。它是我贴在笔记上的标签，可以把住在完全不同位置、但共享同一条线索的内容连起来。一篇关于我如何工作的笔记可以在一条路径里，另一篇完全不同的笔记也可以带着同一个连接。

我暂时定下的规则是：如果我问“它应该放在哪里”，那是路径；如果我问“它还和什么有关”，那是连接。而 [[链接如何工作]] 是第三种关系：两篇具体笔记之间的直接指向，而不是它们共同归属的某个集合。`,
  },
  {
    title: "值得回访的笔记",
...
*几天后的补记：* 回来看这篇时，我留下的那个线头长成了另一篇笔记：[[连接式思考]]。这正是我一直绕着走的模式：开放的问题会长出新的链接。回访这篇笔记让那个连接浮了上来，这大概就是意义所在。`,
  },
  {
    title: "连接式思考",
...
我想，这才是连接笔记而不是归档笔记的真正原因。归档假设我已经知道结构是什么；链接则允许结构自己显现。
